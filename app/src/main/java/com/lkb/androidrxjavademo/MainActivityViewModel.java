...
//    }
    public void init(){
        ...
        AndroidRxJavaApplication.application().getAndroidRxJavaApplicationComponent().inject(this);
        msg.setValue( mservice.getMessage());
    }
    public LiveData<String> getMessageLocal(){
        return msg;
    }
